...
var flags = append([]cli.Flag{
	...
	&cli.StringFlag{
		...
		Sources: cli.EnvVars("WOODPECKER_FORGE_URL", "WOODPECKER_GITHUB_URL", "WOODPECKER_GITLAB_URL", "WOODPECKER_GITEA_URL", "WOODPECKER_GITEE_URL", "WOODPECKER_FORGEJO_URL", "WOODPECKER_BITBUCKET_URL", "WOODPECKER_BITBUCKET_DC_URL"),
	},
	&cli.StringFlag{
		Sources: cli.NewValueSourceChain(
			...
			cli.EnvVar("WOODPECKER_GITEE_CLIENT"),
	...
	&cli.StringFlag{
		Sources: cli.NewValueSourceChain(
			...
			cli.EnvVar("WOODPECKER_GITEE_SECRET"),
